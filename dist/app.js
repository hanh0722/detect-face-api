...
var cors_1 = require("./controller/cors");
var errors_1 = require("./controller/errors");
...
(function () {
    (0, files_1.settingCloudinary)();
})();
app.use((0, multer_1.default)({
    storage: storage,
}).array(key_1.KEY_MULTER));
app.use(cors_1.UseCors);
app.use('/api/detect', routes_1.DetectRoutes);
app.use('/api/files', routes_1.FileRoutes);
app.use(errors_1.UseErrorController);
app.listen(9000);
